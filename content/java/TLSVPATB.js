...
var TLSVPATB = function(
		...
		var _s = this;
		var prototype = TLSVPATB.prototype;
		...
		_s.setupLeftAndRight = function(){
			...
			_s.leftTxt = new TLSVPDisplayObject("div");
			...
			_s.rightTxt = new TLSVPDisplayObject("div");
		...
		_s.updateTime = function(){
			var hasHours = TLSVPUtils.formatTime(_s.duration).length > 5;
			var totalTime = TLSVPUtils.formatTime(_s.duration);
			_s.rightTime = TLSVPUtils.formatTime(_s.duration * _s.pb);
			_s.leftTime = TLSVPUtils.formatTime(_s.duration * _s.pa);
		...
		_s.setupMainScrubber = function(){
			...
			_s.mainScrubber_do = new TLSVPDisplayObject("div");
			...
			_s.mainScrubberBkMiddle_do = new TLSVPDisplayObject("div");	
			...
			//setup progress bar
			_s.mainScrubberDrag_do = new TLSVPDisplayObject("div");
			...
			if(_s.useHEX){
				_s.mainScrubberDragMiddle_do = new TLSVPDisplayObject("div");
				_s.mainScrubberMiddleImage.onload = function(){
					var testCanvas = TLSVPUtils.getCanvasWithModifiedColor(_s.mainScrubberMiddleImage, controller.nBC, true);
			...
			TLSVPTextButton.setPrototype();
			_s.left_do = new TLSVPTextButton(
				'A',
			...
			_s.left_do.addListener(TLSVPTextButton.MOUSE_DOWN, _s.aDown);
			_s.left_do.addListener(TLSVPTextButton.MOUSE_UP, _s.aUp);

			TLSVPTextButton.setPrototype();
			_s.right_do = new TLSVPTextButton(
				'B',
				 _s.buttonTextNormalColor,
				 _s.buttonTextSelectedColor,
				 _s.buttonBackgroundNormalColor,
			...
			_s.right_do.addListener(TLSVPTextButton.MOUSE_DOWN, _s.bDown);
			_s.right_do.addListener(TLSVPTextButton.MOUSE_UP, _s.bUp);
		}

		_s.bDown = function(e){
			_s.scrub = true
			var vc = TLSVPUtils.getViewportMouseCoordinates(e.e);	
			...
			_s.dispatchEvent(TLSVPATB.START_TO_SCRUB);
		}
		...
		_s.bUp = function(e){
			...
			_s.dispatchEvent(TLSVPATB.STOP_TO_SCRUB);
		}

		_s.bMoveHandler = function(e){
			if(e.preventDefault) e.preventDefault();
			var vc = TLSVPUtils.getViewportMouseCoordinates(e);	
	...
	/* set prototype */
	TLSVPATB.setPrototype = function(){
		TLSVPATB.prototype = null;
		TLSVPATB.prototype = new TLSVPTransformDisplayObject("div");
	};

	TLSVPATB.START_TO_SCRUB = "startToScrub";
	TLSVPATB.SCRUB = "scrub";
	TLSVPATB.STOP_TO_SCRUB = "stopToScrub";

	TLSVPATB.prototype = null;
	window.TLSVPATB = TLSVPATB;
}(window));


/* TLSVPTextButton */
(function (window){
var TLSVPTextButton = function(
		label,
		colorN,
		colorS,
		bkColorN,
		...
		var _s = this;
		var prototype = TLSVPTextButton.prototype;
		...
		_s.setupMainContainers = function(){
			...
			_s.dumy_do = new TLSVPDisplayObject("div");
			if(TLSVPUtils.isIE){
		...
		_s.onMouseDown = function(e){
			...
			_s.dispatchEvent(TLSVPTextButton.MOUSE_DOWN, {e:e});
		};

		_s.checkUp = function(e){
			var vc = TLSVPUtils.getViewportMouseCoordinates(e);	
			if(!TLSVPUtils.hitTest(_s.screen, vc.screenX, vc.screenY)){
				_s.setNormalState();	
				if(!_s.isMbl){
			...
			_s.dispatchEvent(TLSVPTextButton.MOUSE_UP);
		}
	...
	/* set prototype */
	TLSVPTextButton.setPrototype = function(){
		TLSVPTextButton.prototype = null;
		TLSVPTextButton.prototype = new TLSVPDisplayObject("div");
	};
	
	TLSVPTextButton.MOUSE_UP = 'mouseUp';
	TLSVPTextButton.MOUSE_DOWN = 'mouseDown';
	
	TLSVPTextButton.prototype = null;
	window.TLSVPTextButton = TLSVPTextButton;
}(window));